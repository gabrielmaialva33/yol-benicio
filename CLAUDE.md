...
YOL-BENICIO is a legal services management platform for Benício Advogados, built with React, TypeScript, and Vite. The
application features a dashboard-based interface for managing legal folders, clients, tasks, and other law firm
operations.
