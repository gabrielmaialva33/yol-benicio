...
export function ConversationList({
	...
	return (
		<div className='flex h-full w-64 flex-col border-border border-r bg-surface'>
			{/* Header */}
				...
				{conversations.length === 0 ? (
					...
					conversations.map(conversation => (
						...
						>
							...
							<button
								className='invisible rounded p-1 text-gray-400 transition-colors hover:bg-red-100 hover:text-red-600 disabled:cursor-not-allowed disabled:opacity-50 group-hover:visible'
								disabled={isDeleting}
			...
			{/* Footer info */}
			<div className='border-border border-t p-3 text-gray-500 text-xs'>
				{conversations.length > 0
