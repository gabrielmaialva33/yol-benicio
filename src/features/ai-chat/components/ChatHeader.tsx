...
export function ChatHeader({
	...
	return (
		<div className='flex items-center justify-between border-border border-b bg-surface p-4'>
			...
			{conversationId && onDeleteConversation && (
				<button
					className='flex items-center gap-2 rounded-lg border border-red-200 bg-red-50 px-3 py-2 text-red-600 text-sm transition-colors hover:bg-red-100'
